<?php
    ...
    if(!function_exists('parse_file')){
        function parse_file($file, $line)
        {
            ...
            return '<a class="toggle">'.$file." line {$line}".'</a>';
        }
    }
...
<body>
    ...
    <div class="copyright">
        <a title="林梦网络" href="http://www.lmwljz.com">lmwljz.com</a> 
        <span>[<a title="懂我音乐" href="http://y.lmwljz.com">懂我音乐</a>]</span>
	<span>V<?php echo LMWL_VERSION; ?></span> 
        <span>{ 专注互联网高级开发 }</span>
    </div>
    <?php if(\think\App::$debug) { ?>
    <script>
